...
from _calendar.database import Database
from _calendar.backends import CalendarSource, BackendError

import _calendar.backends.ical
import _calendar.backends.evo
import _calendar.backends.gcal
...
class EventManager(gobject.GObject):
    ...
    __gsignals__ = {
        ...
        'calendar-added': (gobject.SIGNAL_RUN_LAST, gobject.TYPE_NONE, (gobject.TYPE_STRING, gobject.TYPE_PYOBJECT, gobject.TYPE_BOOLEAN)),
    ...
    def init_source(self, source):
        ...
        if not source.uid in self.sources:
            cal_source = get_source_for_type(source.type)(source.uid, source.data,
                                                          source.calendars)
    ...
    def on_calendar_added(self, source, calendar_uid, calendar):
        ...
        self.emit('calendar-added', calendar_uid, calendar, source.requires_authentication)
